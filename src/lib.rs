...
#[derive(Debug)]
pub struct DeployScriptProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DeployScriptProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DeployScript processing");
    
    let mut processor = DeployScriptProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DeployScriptProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DeployScriptProcessor::new(false);
